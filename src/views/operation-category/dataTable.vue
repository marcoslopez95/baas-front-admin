...
import { Store } from '@/stores/operationCategoryStore';
// import UploadVoucher from './UploadVoucher.vue';

const store = Store()
const helper = helperStore()
helper.url = '/api/configs/operation-category'
...
<template>
  ...
  >
    <VCard>
      <VCardTitle>{{$t('commons.Update')}} {{$t('views.operation-categories.singular')}}</VCardTitle>
      <VCardText>
        <VRow>
          <VCol cols="12">

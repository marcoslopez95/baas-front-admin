...
import { Store } from '@/stores/operationStatusStore';
// import UploadVoucher from './UploadVoucher.vue';

const store = Store()
const helper = helperStore()
helper.url = '/api/configs/operation-status'
...
<template>
  ...
  >
    <VCard>
      <VCardTitle>{{$t('commons.Update')}} {{$t('views.operation-status.singular')}}</VCardTitle>
      <VCardText>
        <VRow>
          <VCol cols="12">

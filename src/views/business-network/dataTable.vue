...
import { Store } from '@/stores/businessNetworkStore';
// import UploadVoucher from './UploadVoucher.vue';

const store = Store()
const helper = helperStore()
helper.url = '/api/configs/business-networks'
  ...
  >
    <thead>
      <tr>
        ...
        <th class="text-center text-uppercase">{{$t('tables.headers.Description')}}</th>
